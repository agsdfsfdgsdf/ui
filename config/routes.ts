...
export default [
  ...
  },
  {
    ...
    routes: [
      {
        path: '/websoket',
        redirect: '/websoket/video',
      },
      {
        name: '海康视频监控',
        icon: 'PartitionOutlined',
        path: '/websoket/video',
        component: 'websoket/video',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.websoket.video',
      },
    ],
  },
  {
    ...
    routes: [
      {
        path: '/websokets',
        redirect: '/websokets/flv',
      },
      {
        name: '海康视频监控',
        icon: 'PartitionOutlined',
        path: '/websokets/flv',
        component: 'websokets/flv',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.websokets.flv',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        component: 'operation/instructions/index',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.operationInstructions',
      },
      {
        name: '吊桥数据',
        icon: 'PartitionOutlined',
        path: '/operation/drawbridge',
        component: 'operation/drawbridge/index',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.operationDrawbridge',
      },
      {
        name: '告警数据统计',
        icon: 'PartitionOutlined',
        path: '/operation/warnCount',
        component: 'operation/warnCount/index',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.operationWarnCount',
      },
      {
        name: '上传文件',
        icon: 'PartitionOutlined',
        path: '/operation/upload',
        component: 'operation/upload/SearchData',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.operatioupload',
      },
    ],
  },
  {
