...
export default {
  ...
  'system.User.nick_name_hit': '请输入用户昵称！',
  'system.User.phonenumber_hit': '请输入手机号码！',
  'system.User.email_hit': '请输入邮箱！',
  'system.User.sex_hit': '请输入性别！',

  'system.User.old_password_hit': '请输入旧密码！',
  'system.User.new_password_hit': '请输入新密码！',
  'system.User.confirm_password_hit': '请输入确认密码！',
};
