            ...
            rules={[
              {
                ...
                message: (
                  <FormattedMessage
                    id="system.User.phonenumber_hit"
          ...
          <ProFormText
            ...
            rules={[
              ...
              },
              {
                required: false,
                message: (
                  <FormattedMessage id="system.User.email_hit" defaultMessage="请输入邮箱！" />
                ),
              },
            ]}
          />
            ...
            rules={[
              {
                required: false,
                message: (
                  <FormattedMessage id="system.User.sex_hit" defaultMessage="请输入性别！" />
                ),
              },
            ]}
          />
