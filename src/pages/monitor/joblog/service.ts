...
export async function getJobLogList(params?: JobLogListParams) {
  ...
  return request(getUrl(`/api/monitor/jobLog/list?${queryString}`), {
    data: params,
    method: 'GET',
    headers: {
...
export function getJobLog(jobJobLogId: number) {
  return request(getUrl(`/api/monitor/jobLog/${jobJobLogId}`), {
    method: 'GET',
  });
}
...
export async function addJobLog(params: JobLogType) {
  return request(getUrl('/api/monitor/jobLog'), {
    method: 'POST',
    data: params,
  });
}
...
export async function removeJobLog(ids: string) {
  return request(getUrl(`/api/monitor/jobLog/${ids}`), {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
...
export function exportJobLog(params?: JobLogListParams) {
  return downLoadXlsx(
    getUrl(`/api/monitor/jobLog/export`),
    { params },
...
export function cleanJobLog() {
  return request(getUrl('/api/monitor/jobLog/clean'), {
    method: 'DELETE',
  });
}
