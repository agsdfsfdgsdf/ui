...
export async function getDictDataList(params?: DictDataListParams) {
  ...
  return request(getUrl(`/api/system/dict/data/list?${queryString}`), {
    data: params,
    method: 'GET',
    headers: {
...
export function getDictData(dictCode: string) {
  return request(getUrl(`/api/system/dict/data/${dictCode}`), {
    method: 'GET',
  });
}
...
export async function addDictData(params: DictDataType) {
  return request(getUrl('/api/system/dict/data'), {
    method: 'POST',
    data: params,
  });
}
...
export async function removeDictData(ids: string) {
  return request(getUrl(`/api/system/dict/data/${ids}`), {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8',
    },
...
export function exportDictData(params?: DictDataListParams) {
  return downLoadXlsx(
    getUrl(`/api/system/dict/data/export`),
    { params },
