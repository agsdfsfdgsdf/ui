...
const UserForm: React.FC<UserFormProps> = (props) => {
  ...
  useEffect(() => {
    ...
    console.log('Gunson', props.postIds, props.roleIds);
    form.setFieldsValue({
    ...
    >
      <Form form={form} onFinish={handleFinish} initialValues={props.values}>
              ...
              rules={[
                {
                  required: true,
                  message: (
                    <FormattedMessage id="请选择所属部门！" defaultMessage="请选择所属部门！" />
                  ),
                },
              ]}
            />
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col span={12} order={2} hidden={userId === 1}>
            <ProFormSelect
              name="roleIds"
              mode="multiple"
              width="xl"
              ...
              options={roles}
              placeholder="请选择角色"
              rules={[{ required: userId !== 1, message: '请选择角色!' }]}
            />
          </Col>
        </Row>
        <Row gutter={[16, 16]}>
